...
connStr = (
    ...
    "\\03data\\20181207_waterbalans.accdb;"
    )
...
# manual testing
# EAG_list = [(19518, '2130-EAG-2', 'Noorder Legmeerpolder, Bovenkerk', 7826)]
# EAG_list = [(19524, '2140-EAG-3', 'Uithoornsche Polder, Zijdelmeer', 7827)]
