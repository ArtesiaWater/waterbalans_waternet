...
excelfiles = [i for i in os.listdir(exceldir) if i.endswith(".xls") or i.endswith(".xlsx")]
...
# for f in excelfiles:
    ...
    try:
        ...
        print("Error! {0} was not scraped due to {1}:{2}".format(f, e.__class__.__name__, e), file=log)
        continue
